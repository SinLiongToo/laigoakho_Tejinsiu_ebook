...
<head>
  ...
  <style>
    ...
    [data-theme="dark"] {
      /* Dark Mode Variables - Ultra Crisp Contrast & Legibility */
      --bg-primary: #0b0f19;
      --bg-secondary: #131b2e;
      --bg-sidebar: #111827;
      --text-primary: #ffffff;
    ...
    /* ==========================================================================
       Coverpage Styling (Light & Dark Mode)
       ========================================================================== */
    section.cover {
    ...
    /* ==========================================================================
       Dark Mode Universal Ultra-Contrast Typography Overrides
       ========================================================================== */
    ...
    [data-theme="dark"] .markdown-section small,
    ...
    [data-theme="dark"] .markdown-section a {
      color: #38bdf8 !important; /* Bright sky blue / cyan for dark mode */
    }
    ...
    [data-theme="dark"] .figure-caption em,
    ...
    /* Dedicated Search Results Panel with High-Visibility Scrollbar */
    .results-panel,
    ...
    .sidebar .search .results-panel {
      ...
      scrollbar-color: #0284c7 var(--bg-secondary) !important;
    }

    .results-panel.hide,
    .sidebar .results-panel:empty {
      display: none !important;
    }

    /* Search Results Scrollbar (11px wide, vivid cyan/teal thumb) */
    ...
    .sidebar .results-panel::-webkit-scrollbar-track {
      background: var(--bg-secondary) !important;
      border-radius: 6px !important;
    }

    .results-panel::-webkit-scrollbar-thumb,
    .sidebar .results-panel::-webkit-scrollbar-thumb {
    ...
    .sidebar .results-panel::-webkit-scrollbar-thumb:hover {
      background: #0369a1 !important;
    }

    [data-theme="dark"] .results-panel::-webkit-scrollbar-thumb,
    [data-theme="dark"] .sidebar .results-panel::-webkit-scrollbar-thumb {
    ...
    @media screen and (max-width: 768px) {
      ...
      /* Docsify mobile: body.close means sidebar is OPEN on mobile */
      body.close .sidebar {
...
<body>
  ...
  <script>
    ...
    // --------------------------------------------------------------------------
    // One-Click Sidebar Collapse / Expand Functionality (左側一鍵全部收合/展開)
    // --------------------------------------------------------------------------
