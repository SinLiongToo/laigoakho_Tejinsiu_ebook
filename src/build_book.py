...
<head>
  ...
  <style>
    ...
    /* ==========================================================================
       Dedicated Search Panel & Full Sidebar Search Results Window
       ========================================================================== */
    .sidebar .search {
      position: relative;
    ...
    /* Hide collapse toolbar when search results are showing */
    .sidebar:has(.results-panel.show) .sidebar-collapse-toolbar {
      display: none !important;
    }

    /* Search Results Window taking over the sidebar */
  ...
  <script>
    ...
    window.$docsify = {
      ...
      plugins: [
        function(hook, vm) {
          hook.init(function() {
            // Clear legacy broken search cache keys
            try {
              for (var k in localStorage) {
                if (k.startsWith('docsify.search') && !k.includes('laigoakho_v4')) {
